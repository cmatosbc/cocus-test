 ...
 */
final class Version20250328134346 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE note ADD user_id INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE note ALTER message TYPE VARCHAR(255)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE note ALTER type SET NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX IDX_CFBDFA14A76ED395
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE note DROP user_id
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE note ALTER message TYPE VARCHAR(2048)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE note ALTER type DROP NOT NULL
        SQL);
    }
}
